(function () {
    var adminNewsCtrl = function ($scope, $cookieStore, $http, $rootScope) {
        $scope.view = {};
		$scope.data = {};
		$scope.currentPage = 1;
		$scope.pagination = 5;
    ...
    adminNewsCtrl.$inject = ['$scope', '$cookieStore', '$http', '$rootScope'];
    angular.module('FICOnWeb').controller('adminNewsCtrl', adminNewsCtrl);
}());